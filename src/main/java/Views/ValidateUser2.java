...
public class ValidateUser2 extends javax.swing.JFrame {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (uname.equals("Manager")) {
                    ...
                    AllocateEmployee ui = new AllocateEmployee();
                    ui.setVisible(true);
                    dispose();
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ValidateUser2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ValidateUser2().setVisible(true);
            }
        });
    }
