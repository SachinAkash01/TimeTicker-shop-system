...
public class ValidateUser1 extends javax.swing.JFrame {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (uname.equals("Manager")) {
                    ...
                    IncomeExpense ui = new IncomeExpense();
                    ui.setVisible(true);
                    dispose();
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ValidateUser1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ValidateUser1().setVisible(true);
            }
        });
    }
